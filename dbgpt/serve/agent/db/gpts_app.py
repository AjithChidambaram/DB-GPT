...
class GptsAppDetail(BaseModel):
    ...
    def from_dict(cls, d: Dict[str, Any]):
        return cls(
            ...
            llm_strategy_value=",".join(json.loads(d.get("llm_strategy_value"))) if d.get("llm_strategy_value") else None,
            ...
            for item in gpts_app.details:
                ...
                app_details.append(
                    GptsAppDetailEntity(
                        ...
                        llm_strategy_value=json.dumps(tuple(item.llm_strategy_value.split(','))),
